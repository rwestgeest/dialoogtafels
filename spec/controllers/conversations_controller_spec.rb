...
describe ConversationsController do
  ...
  context "without supplying a location" do
    ...
    def response_of(*params)
      xhr *params
      self
    end
    it { response_of(:get, :new).should respond_with(404) }
    it { response_of(:post, :create, :conversation => valid_attributes).should respond_with(404) }
    it { response_of(:get, :show, :id => conversation.to_param).should respond_with(404) }
    it { response_of(:get, :edit, :id => conversation.to_param).should respond_with(404) }
    it { response_of(:put, :update, :id => conversation.to_param, :conversation => valid_attributes).should respond_with(404) }
  end
